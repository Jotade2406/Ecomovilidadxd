...
public class JwtTokenProvider {
    ...
    /**
     * Genera un JWT con los claims estándar + tenant_id, tenant_nombre y role.
     */
    public String generateToken(String email, String role, UUID tenantId, String tenantNombre) {
        Date now = new Date();
        ...
        return Jwts.builder()
                ...
                .claim("tenant_nombre", tenantNombre)
                .issuer(issuer)
